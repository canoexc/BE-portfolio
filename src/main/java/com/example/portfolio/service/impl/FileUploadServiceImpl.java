...
import com.example.portfolio.util.StatusCode;
import com.example.portfolio.config.AliyunOssConfig;
...
//        response.setCharacterEncoding("UTF-8");
        // 文件名以附件的形式下载
        response.setHeader("Content-Disposition", "attachment;filename=" + URLEncoder.encode(fileName.substring(66), "UTF-8"));
...
//        String fileKey ="test1/2021/01/20/696631cf-208d-46fe-9e96-bc39f2565009.jpg";
        ...
        String fileKey = fileName.substring(51);
